...
const books = [
  {
    title: '《河防通议》',
    subtitle: '精细到"步"的工程规范',
    sections: [
      {
        heading: '治水的极致：成就"精密工程"的系统化管理',
        intro: '如果您想了解中国古代在修建大型水利工程时如何进行精细化管理，《河防通议》是一部绕不开的经典。这部著作由北宋沈立初撰、元代沙克什重编，系统记载了宋金元三代治理黄河的工程规章制度，全书仅1.8万字，却分为河议、制度、料例、功程、输运、算法六大部分。',
        paragraphs: [
          '它最大的突破在于确立了量化管理的传统。书中提出的"历步减土"法则尤为精彩：将筑堤取土按运距远近分为7个区间，每个区间规定一个"功"（即现在的"工"）应完成的土方量——50步以内取土时，1步应完成100立尺为1功，运距每增加1步土方减1立尺；远至3600步时，则以每担60斤、往返60里为1功，每个区间还精确匹配了夯土与装土的辅工定额。',
          '这种将物料运输距离与用工量精确绑定的管理体系，展现了古代工程管理的高度精细化。此外，书中还确立了埽工修筑、堵口闭河、堤防测量等关键技术规范，并收录金代"河防令"，建立起完整的河防管理体系，在黄河流域应用逾三百年。'
        ]
      }
    ]
  },
  {
    ...
    sections: [
      {
        heading: '将工匠智慧与士人视野融会贯通',
        intro: '如果说《河防通议》聚焦于水利这一个领域，那么《天工开物》则以宏阔的视野，勾勒出中国古代农业与手工业的整体技术版图。',
        paragraphs: [
          '这部被誉为"17世纪的工艺百科全书"的著作，由明末科学家宋应星编撰。有意思的是，宋应星五试不第后遍游各地，在田边、作坊中实地考察了大量农业与手工业实践，从东北捕貂到南海采珠无所不包，最终写成此书。他在自序中写道："此书于功名进取毫不相关也！"这句掷地有声的话，道出了他将目光投向田野而非科场的决心。',
          '史家研究认为，宋应星并非被动记录技术经验，而是"运用以道察器的考察理念整合工匠技术知识，并将士人群体的人文关怀赋予工匠技术活动"，形成了独特的"天工开物"思想。它揭示了古人对"物性"的深刻洞察——尊重材料的特性，顺着物性加以改造利用，成就了古代工程质朴而深邃的智慧。',
          '尤其值得注意的是，英国科学史家李约瑟在《中国科学技术史》中列举了"中国向西方世界传播最主要的26项技术"，其中《天工开物》论述到的就有18项。这本书的后半程还有一个极佳的延伸阅读选项：《工开万物：17世纪中国的知识与技术》（[德]薛凤 著），该书将《天工开物》置于晚明宏阔的历史背景之下，深度解读了宋应星的思想脉络，值得一并阅读。'
        ]
      }
    ]
  },
  {
    title: '《工程做法》',
    subtitle: '最早的"国标"标准化体系',
    sections: [
      {
        heading: '让宫殿层层叠叠却纹丝不动的模数设计',
        intro: '如果说前面两本书侧重"做什么"，那么《工程做法》解决的是"怎么做以及怎么做才标准"的问题。这部由果亲王允礼主持编纂、清雍正十二年工部颁布的建筑技术规范，是继宋代《营造法式》之后官方颁布的第二部系统性建筑工程专著，全书七十四卷，长期作为宫殿、坛庙等官式建筑的营造准则。',
        paragraphs: [
          '其核心贡献在于确立了一套以"斗口"为基本模数的标准化设计体系。斗口以斗拱坐斗的开口宽度为基本模数单位，共分为十一等，自1寸起每等加0.5寸至6寸止。紫禁城内几乎所有建筑均以斗口尺寸为基准，只要确定了用材等级，整个建筑的体量大小即可按比例推演确定。',
          '这一制度使得官式建筑得以规模化和标准化建造，同时保证了不同工匠建造出的建筑在风格、结构与尺度上的高度统一。在营造分工上，该书体系涵盖大木作、斗栱作、石作、瓦作、土作、油作、画作等十一个专业，按工种细分约二十多个工种。这种建立在模数化设计与专业化协作之上的工程组织方式，是中国古代建筑技术高度发达的有力证明。'
        ]
      }
    ]
  },
  {
    ...
    sections: [
      {
        heading: '赵州桥、洛阳桥、广济桥……那些古代"桥梁黑科技"',
        intro: '最后，当我们把视角收拢到"一座桥"——这个工程技术与艺术美学高度凝练的创造物上时，《中国桥谱》便成了一本极佳的索引手册，它将散落在华夏大地上的桥梁杰作一一归拢，呈现出中国古桥完整的技术谱系。',
        paragraphs: [
          '其中赵州桥堪称典范。这座由隋代匠师李春设计建造的敞肩圆弧石拱桥，距今已有1400余年历史，是当今世界上现存最早、保存最完善的敞肩石拱桥。考古学家和桥梁专家都指出，它所体现的"敞肩拱"结构能够有效减小洪水对桥体的冲击，而中空的小券则兼具节省石料、减轻自重和泄洪的多重功能。',
          '洛阳桥同样令人叹为观止——这座始建于北宋的跨海石桥，在江海交汇处的淤泥上，工匠们创造性地采用了"筏形桥基"、"种蛎固基"和"浮运架梁"三大法宝：先抛石铺底形成"石床"，再在桥墩石缝间人工养殖牡蛎，让贝类钙质将石块牢牢胶结成坚固整体，最后利用潮汐涨落实现在桥墩间的精准落梁。',
          '有人将其巧妙概括为古人建桥的三大"黑科技"：赵州桥的"敞肩拱"、洛阳桥的"种蛎固基"、广济桥的"浮梁结合"，这些无需现代仪器的设计，既适配自然环境，又兼顾实用功能，是古代工程与自然规律的完美融合。'
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          '李春最具开创性的贡献，是发明了**敞肩拱**结构设计，在主拱两端增设四个小拱，这一创新不仅大幅减轻桥身自重、节省建材，更极大提升了桥梁的泄洪能力与抗震性能，完美适配河流汛期的水文特点。这一结构设计，比欧洲同类桥梁技术早出现近七百年，是中国古代桥梁工程领先世界的核心佐证。唐代张嘉贞在《安济桥铭》中曾赞叹其"制造奇特，人不知其所为"，足以见其工艺精妙、设计超前。',
...
const toggle = (key) => {
  ...
  if (key === 'literature') {
    ...
    currentDesc.value = '中国古代工程典籍与桥梁人物详解'
  }
}
</script>
